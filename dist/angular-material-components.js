 ...
 * Created by FG0003 on 10/04/2017.
 */
let configs = angular.module('angular-material-simple-components.configs', ['ngMaterial']);
...
class PaginationController {
    ...
    get numberOfPages() {
        if (this.nItems == 0 || this.nItems == null) return 1;
...
class TextInputController extends __WEBPACK_IMPORTED_MODULE_0__AbstractInputComponent_AbstractInputComponent__["a" /* AbstractInputController */] {
    ...
    initialize() {
        ...
        if (this.type != 'text' && this.type != 'email' && this.type != 'password' && this.type != 'url') throw 'The type must be equals "text", "email", "password" or "url"';
    }
...
/* harmony default export */ __webpack_exports__["default"] = (angular.module('angular-material-simple-components', [__WEBPACK_IMPORTED_MODULE_1__configs_index_configs__["a" /* default */].name, __WEBPACK_IMPORTED_MODULE_2__services_index_services__["a" /* default */].name, __WEBPACK_IMPORTED_MODULE_3__components_index_components__["a" /* default */].name, __WEBPACK_IMPORTED_MODULE_4__directives_index_directives__["a" /* default */].name]).name);
